...
class TestClassSchema(unittest.TestCase):
    ...
    def test_validator_stacking(self):
        ...
        CustomTypeOneValidator = NewType("CustomTypeOneValidator", str, validate=validator_a)
        CustomTypeNoneValidator = NewType("CustomTypeNoneValidator", str, validate=None)
        CustomTypeMultiValidator = NewType("CustomTypeNoneValidator", str, validate=[validator_a, validator_b])
        ...
        @dataclasses.dataclass
        class B:
            data: CustomTypeNoneValidator = dataclasses.field(metadata={"validate": validator_a})
        ...
        @dataclasses.dataclass
        class C:
            data: CustomTypeNoneValidator = dataclasses.field(metadata={"validate": [validator_a, validator_b]})
        
        schema_c = class_schema(C)()
        self.assertListEqual(schema_c.fields['data'].validators, [validator_a, validator_b])
        ...
        @dataclasses.dataclass
        class E:
            data: CustomTypeOneValidator = dataclasses.field(metadata={"validate": validator_b})
        
        schema_e = class_schema(E)()
        self.assertListEqual(schema_e.fields['data'].validators, [validator_a, validator_b])

        @dataclasses.dataclass
        class F:
            data: CustomTypeOneValidator = dataclasses.field(metadata={"validate": [validator_b, validator_c]})
        
        schema_f = class_schema(F)()
        self.assertListEqual(schema_f.fields['data'].validators, [validator_a, validator_b, validator_c])
        ...
        self.assertListEqual(schema_g.fields['data'].validators, [validator_a, validator_b])
        
        @dataclasses.dataclass
        class H:
            data: CustomTypeMultiValidator = dataclasses.field(metadata={"validate": validator_c})
        
        schema_h = class_schema(H)()
        self.assertListEqual(schema_h.fields['data'].validators, [validator_a, validator_b, validator_c])

        @dataclasses.dataclass
        class I:
            data: CustomTypeMultiValidator = dataclasses.field(metadata={"validate": [validator_c, validator_d]})
        
        schema_i = class_schema(I)()
        self.assertListEqual(schema_i.fields['data'].validators, [validator_a, validator_b, validator_c, validator_d])
